        ...
        <div class="account-content">
            ...
            <div class="container">
                ...
                <div class="account-logo">
                    <a href="index.html"><img src="{{ URL::to('assets/img/logo2.png') }}" alt="HRMS"></a>
                </div>
                {{-- message --}}
                {!! Toastr::message() !!}
                <!-- /Account Logo -->
                <div class="account-box">
                    <div class="account-wrapper">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <br>
                            <div class="account-footer" style="border:2px solid black; border-radius:10px">
                                <p> Login as demo admin </p>
                                <p> User: admin@hrms.com </p>
